                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              title: Text(DateFormat('MMMM')
                                      .format(DateTime.parse(item.date_debut)) +
                                  " " +
                                  DateTime.parse(item.date_debut)
                                      .day
                                      .toString() +
                                  "," +
                                  DateTime.parse(item.date_debut)
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                          "Time period: ${DateTime.parse(item.date_fin).difference(DateTime.parse(item.date_debut)).inDays}"),
