  ...
  Future<void> _fetchTasks() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('${kBaseUrl}task/${widget.project.id}/tasks/'),
      );
  ...
  Future<void> _updateStatus(String taskId, String status) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('${kBaseUrl}task/${taskId}/$status/'),
      );
        ...
        child: Expanded(
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  TextButton(onPressed: (){_updateStatus(task.id,"in progress");}, child: Text("doing")),
                  TextButton(onPressed: (){_updateStatus(task.id,"done");}, child: Text("done")),
                ],
              )
            ],
          ),
